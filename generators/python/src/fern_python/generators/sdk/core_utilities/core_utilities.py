...
class CoreUtilities:
    ...
    def copy_to_project(self, *, project: Project) -> None:
        ...
        self._copy_file_to_project(
            project=project,
            relative_filepath_on_disk="stream_response_manager.py",
            filepath_in_project=Filepath(
                directories=self.filepath,
                file=Filepath.FilepathPart(module_name="stream_response_manager"),
            ),
            exports={"StreamResponseManager", "AsyncStreamResponseManager"},
        )

...
```yml title="fern/docs.yml of this website"
instances:
...
<AccordionGroup>
  ...
  <Accordion title="Multiple APIs">
    ...
    To see what this looks like in practice, check out [DevRev's Fern configuration](https://github.com/devrev/fern-api-docs/tree/main/fern/apis).

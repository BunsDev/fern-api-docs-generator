...
function convertService(
    ...
    for (const irEndpoint of irService.endpoints) {
        ...
        if (irEndpoint.v2Examples != null) {
            ...
            if (Object.keys(irEndpoint.v2Examples.userSpecifiedExamples).length > 0) {
                const userSpecifiedExample = Object.values(irEndpoint.v2Examples.userSpecifiedExamples)[0];
                endpointExample = convertV2HttpEndpointExample({
                    example: userSpecifiedExample,
                    irEndpoint
                });
            } else if (Object.keys(irEndpoint.v2Examples.autogeneratedExamples).length > 0) {
                const autogeneratedExample = Object.values(irEndpoint.v2Examples.autogeneratedExamples)[0];
                endpointExample = convertV2HttpEndpointExample({

...
function convertService(
    ...
    for (const irEndpoint of irService.endpoints) {
        ...
        if (irEndpoint.v2Examples != null) {
            ...
            for (const [name, example] of Object.entries(irEndpoint.v2Examples.userSpecifiedExamples)) {
            ...
            for (const [name, example] of Object.entries(irEndpoint.v2Examples.autogeneratedExamples)) {
                endpointExample = convertV2HttpEndpointExample({
                    exampleName: name,
                    example,
                    irEndpoint
